...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9-GISEL %s
...
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    global_load_ubyte v1, v0, s[2:3] offset:1
; GFX9-GISEL-NEXT:    global_load_ubyte v2, v0, s[2:3]
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-GISEL-NEXT:    v_readfirstlane_b32 s2, v1
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-GISEL-NEXT:    v_readfirstlane_b32 s3, v2
; GFX9-GISEL-NEXT:    s_lshl_b32 s2, s2, 8
; GFX9-GISEL-NEXT:    s_or_b32 s2, s2, s3
; GFX9-GISEL-NEXT:    s_lshl_b32 s3, s2, 16
; GFX9-GISEL-NEXT:    s_flbit_i32_b32 s3, s3
; GFX9-GISEL-NEXT:    s_and_b32 s2, s2, 0xffff
...
; SI-NEXT:    buffer_load_ubyte v5, off, s[8:11], 0 offset:6
; SI-NEXT:    buffer_load_ubyte v6, off, s[8:11], 0
; SI-NEXT:    buffer_load_ubyte v7, off, s[8:11], 0 offset:2
...
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    global_load_ubyte v0, v1, s[2:3] offset:5
; GFX9-GISEL-NEXT:    global_load_ubyte v2, v1, s[2:3] offset:6
; GFX9-GISEL-NEXT:    global_load_ubyte v3, v1, s[2:3] offset:7
; GFX9-GISEL-NEXT:    global_load_ubyte v4, v1, s[2:3] offset:1
; GFX9-GISEL-NEXT:    global_load_ubyte v5, v1, s[2:3] offset:3
; GFX9-GISEL-NEXT:    global_load_ubyte v6, v1, s[2:3] offset:4
; GFX9-GISEL-NEXT:    global_load_ubyte v7, v1, s[2:3]
; GFX9-GISEL-NEXT:    global_load_ubyte v8, v1, s[2:3] offset:2
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(7)
; GFX9-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 8, v0
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(5)
; GFX9-GISEL-NEXT:    v_lshlrev_b32_e32 v3, 8, v3
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(4)
; GFX9-GISEL-NEXT:    v_lshlrev_b32_e32 v4, 8, v4
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(3)
; GFX9-GISEL-NEXT:    v_lshlrev_b32_e32 v5, 8, v5
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(2)
; GFX9-GISEL-NEXT:    v_or_b32_e32 v0, v0, v6
; GFX9-GISEL-NEXT:    v_or_b32_sdwa v2, v3, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-GISEL-NEXT:    v_or_b32_e32 v3, v4, v7
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-GISEL-NEXT:    v_or_b32_sdwa v4, v5, v8 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-GISEL-NEXT:    v_or_b32_e32 v0, v2, v0
; GFX9-GISEL-NEXT:    v_or_b32_e32 v2, v4, v3
; GFX9-GISEL-NEXT:    v_ffbh_u32_e32 v2, v2
; GFX9-GISEL-NEXT:    v_ffbh_u32_e32 v0, v0
; GFX9-GISEL-NEXT:    v_add_u32_e64 v2, v2, 32 clamp
; GFX9-GISEL-NEXT:    v_min_u32_e32 v0, v2, v0
; GFX9-GISEL-NEXT:    v_min_u32_e32 v0, 64, v0
...
; GFX9-GISEL-NEXT:    global_store_short v0, v1, s[0:1]
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v1, s2
; GFX9-GISEL-NEXT:    global_store_byte_d16_hi v0, v1, s[0:1] offset:2
; GFX9-GISEL-NEXT:    s_endpgm
...
; GFX9-GISEL:       ; %bb.0:
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v1, 1, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v1, 2, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v1, 4, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v1, 8, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX9-GISEL-NEXT:    v_xor_b32_e32 v0, -1, v0
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v1, 1, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_and_b32_e32 v1, 0x55555555, v1
; GFX9-GISEL-NEXT:    v_pk_sub_i16 v0, v0, v1
; GFX9-GISEL-NEXT:    v_and_b32_e32 v1, 0x33333333, v0
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v0, 2, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_and_b32_e32 v0, 0x33333333, v0
; GFX9-GISEL-NEXT:    v_pk_add_u16 v0, v1, v0
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v1, 4, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_pk_add_u16 v0, v0, v1
; GFX9-GISEL-NEXT:    v_and_b32_e32 v0, 0xf0f0f0f, v0
; GFX9-GISEL-NEXT:    s_movk_i32 s4, 0x101
; GFX9-GISEL-NEXT:    v_pk_mul_lo_u16 v0, v0, s4 op_sel_hi:[1,0]
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v0, 8, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX9-GISEL:       ; %bb.0:
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-GISEL-NEXT:    v_and_b32_e32 v2, 0xffff0000, v0
...
; GFX9-GISEL-NEXT:    v_ffbh_u32_e32 v1, v1
; GFX9-GISEL-NEXT:    v_perm_b32 v0, v2, v0, s4
; GFX9-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX9-GISEL:       ; %bb.0:
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-GISEL-NEXT:    v_and_b32_e32 v2, 0xffff0000, v1
; GFX9-GISEL-NEXT:    v_and_b32_e32 v3, 0xffff0000, v0
; GFX9-GISEL-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX9-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX9-GISEL-NEXT:    v_ffbh_u32_e32 v2, v2
; GFX9-GISEL-NEXT:    v_ffbh_u32_e32 v3, v3
...
; GFX9-GISEL-NEXT:    v_ffbh_u32_e32 v0, v0
; GFX9-GISEL-NEXT:    s_mov_b32 s4, 0x5040100
; GFX9-GISEL-NEXT:    v_perm_b32 v0, v3, v0, s4
; GFX9-GISEL-NEXT:    v_perm_b32 v1, v2, v1, s4
; GFX9-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX9-GISEL-NEXT:    v_ffbh_u32_e32 v1, v1
; GFX9-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 24, v0
; GFX9-GISEL-NEXT:    v_lshlrev_b16_e32 v2, 8, v1
; GFX9-GISEL-NEXT:    v_ffbh_u32_e32 v0, v0
...
; GFX9-GISEL-NEXT:    v_pk_lshlrev_b16 v0, 9, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v1, 1, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX9-GISEL-NEXT:    v_pk_lshrrev_b16 v1, 2, v0 op_sel_hi:[0,1]
; GFX9-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
