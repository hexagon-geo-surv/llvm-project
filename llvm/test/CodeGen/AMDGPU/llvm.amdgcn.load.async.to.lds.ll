...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck %s --check-prefix=GFX90A
...
; xUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx942 < %s | FileCheck %s --check-prefix=GFX942-GISEL
...
declare void @llvm.amdgcn.load.async.to.lds.p1(ptr addrspace(1) nocapture %gptr, ptr addrspace(3) nocapture %lptr, i32 %size, i32 %offset, i32 %aux)
declare void @llvm.amdgcn.load.async.to.lds.p7(ptr addrspace(7) nocapture %gptr, ptr addrspace(3) nocapture %lptr, i32 %size, i32 %offset, i32 %aux)

define amdgpu_ps void @global_load_async_lds_dword_vaddr_saddr(ptr addrspace(1) nocapture %gptr, ptr addrspace(3) nocapture inreg %lptr) {
; GFX90A-LABEL: global_load_async_lds_dword_vaddr_saddr:
...
;
; GFX942-LABEL: global_load_async_lds_dword_vaddr_saddr:
...
;
; GFX10-LABEL: global_load_async_lds_dword_vaddr_saddr:
; GFX10:       ; %bb.0: ; %main_body
; GFX10-NEXT:    s_mov_b32 m0, s0
; GFX10-NEXT:    global_load_dword v[0:1], off offset:16 glc lds
; GFX10-NEXT:    s_endpgm
;
; GFX942-GISEL-LABEL: global_load_async_lds_dword_vaddr_saddr:
...
main_body:
  call void @llvm.amdgcn.load.async.to.lds.p1(ptr addrspace(1) %gptr, ptr addrspace(3) %lptr, i32 4, i32 16, i32 1)
  ret void
}

define amdgpu_ps void @global_load_async_lds_dword_vaddr_vladdr(ptr addrspace(1) nocapture %gptr, ptr addrspace(3) nocapture %lptr) {
; GFX90A-LABEL: global_load_async_lds_dword_vaddr_vladdr:
; GFX90A:       ; %bb.0: ; %main_body
...
; GFX90A-NEXT:    s_endpgm
;
; GFX942-LABEL: global_load_async_lds_dword_vaddr_vladdr:
; GFX942:       ; %bb.0: ; %main_body
...
; GFX942-NEXT:    s_endpgm
;
; GFX10-LABEL: global_load_async_lds_dword_vaddr_vladdr:
; GFX10:       ; %bb.0: ; %main_body
...
; GFX10-NEXT:    s_endpgm
;
; GFX942-GISEL-LABEL: global_load_async_lds_dword_vaddr_vladdr:
; GFX942-GISEL:       ; %bb.0: ; %main_body
