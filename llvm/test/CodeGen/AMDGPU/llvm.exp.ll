...
; VI-NEXT:    v_mov_b32_e32 v0, 0x3fb8a000
...
; VI-NEXT:    v_mov_b32_e32 v3, 0x39a3b295
...
; VI-NEXT:    v_mov_b32_e32 v1, 0xc2ce8ed0
; VI-NEXT:    v_cmp_nlt_f32_e32 vcc, s2, v1
; VI-NEXT:    v_mov_b32_e32 v1, 0x42b17218
...
; GFX900-NEXT:    v_mov_b32_e32 v1, 0x32a5705f
...
; GFX900-NEXT:    v_mov_b32_e32 v1, 0xc2ce8ed0
; GFX900-NEXT:    v_cmp_nlt_f32_e32 vcc, s2, v1
; GFX900-NEXT:    v_mov_b32_e32 v1, 0x42b17218
...
; SI-NEXT:    v_mov_b32_e32 v1, 0x32a5705f
...
; SI-NEXT:    v_mov_b32_e32 v1, 0xc2ce8ed0
; SI-NEXT:    v_cmp_nlt_f32_e32 vcc, s6, v1
; SI-NEXT:    v_mov_b32_e32 v1, 0x42b17218
...
; VI-NEXT:    v_mov_b32_e32 v4, 0x39a3b295
...
; VI-NEXT:    v_mul_f32_e32 v7, 0x39a3b295, v6
; VI-NEXT:    v_mul_f32_e32 v6, 0x3fb8a000, v6
...
; VI-NEXT:    v_mov_b32_e32 v2, 0xc2ce8ed0
; VI-NEXT:    v_cmp_nlt_f32_e32 vcc, s3, v2
; VI-NEXT:    v_mov_b32_e32 v3, 0x42b17218
...
; VI-NEXT:    s_endpgm
;
; GFX900-LABEL: s_exp_v2f32:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX900-NEXT:    v_mov_b32_e32 v0, 0x3fb8aa3b
; GFX900-NEXT:    v_mov_b32_e32 v1, 0x32a5705f
; GFX900-NEXT:    v_mov_b32_e32 v5, 0xc2ce8ed0
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX900-NEXT:    v_mov_b32_e32 v3, 0x42b17218
...
; SI-NEXT:    v_mov_b32_e32 v3, 0xc2ce8ed0
; SI-NEXT:    v_cmp_nlt_f32_e32 vcc, s5, v3
; SI-NEXT:    v_mov_b32_e32 v4, 0x42b17218
...
; VI-NEXT:    v_mul_f32_e32 v8, 0x39a3b295, v7
; VI-NEXT:    v_mul_f32_e32 v7, 0x3fb8a000, v7
...
; VI-NEXT:    v_mov_b32_e32 v3, 0xc2ce8ed0
; VI-NEXT:    v_cmp_nlt_f32_e32 vcc, s2, v3
; VI-NEXT:    v_mov_b32_e32 v5, 0x42b17218
; VI-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
...
; VI-NEXT:    v_mul_f32_e32 v9, 0x39a3b295, v7
; VI-NEXT:    v_mul_f32_e32 v7, 0x3fb8a000, v7
...
; GFX900-NEXT:    v_ldexp_f32 v2, v2, v3
; GFX900-NEXT:    v_mov_b32_e32 v3, 0xc2ce8ed0
...
; GFX900-NEXT:    s_endpgm
;
; SI-LABEL: s_exp_v3f32:
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0xd
; SI-NEXT:    v_mov_b32_e32 v0, 0x3fb8aa3b
; SI-NEXT:    v_mov_b32_e32 v2, 0x32a5705f
...
; VI-LABEL: s_exp_v4f32:
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; VI-NEXT:    v_mov_b32_e32 v0, 0x3fb8a000
; VI-NEXT:    v_mov_b32_e32 v6, 0x42b17218
; VI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x24
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    v_add_f32_e32 v7, v8, v7
; VI-NEXT:    v_mov_b32_e32 v5, 0xc2ce8ed0
; VI-NEXT:    v_add_f32_e32 v2, v2, v7
...
; VI-NEXT:    v_mul_f32_e32 v2, s3, v0
; VI-NEXT:    v_mul_f32_e32 v10, 0x39a3b295, v9
; VI-NEXT:    v_mul_f32_e32 v9, 0x3fb8a000, v9
...
; GFX900-NEXT:    v_exp_f32_e32 v2, v2
; GFX900-NEXT:    v_cmp_nlt_f32_e32 vcc, s3, v5
; GFX900-NEXT:    v_mov_b32_e32 v6, 0x42b17218
...
; GFX900-NEXT:    s_endpgm
;
; SI-LABEL: s_exp_v4f32:
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0xd
; SI-NEXT:    v_mov_b32_e32 v0, 0x3fb8aa3b
; SI-NEXT:    v_mov_b32_e32 v1, 0x32a5705f
; SI-NEXT:    v_mov_b32_e32 v5, 0x42b17218
...
; SI-NEXT:    v_exp_f32_e32 v2, v2
; SI-NEXT:    v_cvt_i32_f32_e32 v3, v3
; SI-NEXT:    v_mov_b32_e32 v4, 0xc2ce8ed0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_fneg_fabs_f32:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    s_mov_b32 s4, 0xbfb8aa3b
; GFX900-NEXT:    v_mul_f32_e64 v1, |v0|, s4
; GFX900-NEXT:    v_rndne_f32_e32 v2, v1
; GFX900-NEXT:    v_sub_f32_e32 v3, v1, v2
; GFX900-NEXT:    v_fma_f32 v1, |v0|, s4, -v1
; GFX900-NEXT:    s_mov_b32 s4, 0xb2a5705f
; GFX900-NEXT:    v_fma_f32 v1, |v0|, s4, v1
; GFX900-NEXT:    v_add_f32_e32 v1, v3, v1
; GFX900-NEXT:    v_exp_f32_e32 v1, v1
; GFX900-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GFX900-NEXT:    s_mov_b32 s4, 0x42ce8ed0
; GFX900-NEXT:    v_cmp_ngt_f32_e64 vcc, |v0|, s4
; GFX900-NEXT:    s_mov_b32 s4, 0xc2b17218
; GFX900-NEXT:    v_ldexp_f32 v1, v1, v2
; GFX900-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; GFX900-NEXT:    v_mov_b32_e32 v2, 0x7f800000
; GFX900-NEXT:    v_cmp_nlt_f32_e64 vcc, |v0|, s4
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SI-LABEL: v_exp_fneg_fabs_f32:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, 0xbfb8aa3b
; SI-NEXT:    v_mul_f32_e64 v1, |v0|, s4
; SI-NEXT:    v_rndne_f32_e32 v2, v1
; SI-NEXT:    v_sub_f32_e32 v3, v1, v2
; SI-NEXT:    v_fma_f32 v1, |v0|, s4, -v1
; SI-NEXT:    s_mov_b32 s4, 0xb2a5705f
; SI-NEXT:    v_fma_f32 v1, |v0|, s4, v1
; SI-NEXT:    v_add_f32_e32 v1, v3, v1
; SI-NEXT:    v_exp_f32_e32 v1, v1
; SI-NEXT:    v_cvt_i32_f32_e32 v2, v2
; SI-NEXT:    s_mov_b32 s4, 0x42ce8ed0
; SI-NEXT:    v_cmp_ngt_f32_e64 vcc, |v0|, s4
; SI-NEXT:    s_mov_b32 s4, 0xc2b17218
; SI-NEXT:    v_ldexp_f32_e32 v1, v1, v2
; SI-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; SI-NEXT:    v_mov_b32_e32 v2, 0x7f800000
; SI-NEXT:    v_cmp_nlt_f32_e64 vcc, |v0|, s4
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_fneg_f32:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0xbfb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0xbfb8aa3b
; GFX900-NEXT:    v_rndne_f32_e32 v2, v1
; GFX900-NEXT:    v_sub_f32_e32 v3, v1, v2
; GFX900-NEXT:    v_fma_f32 v1, v0, s4, -v1
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SI-LABEL: v_exp_fneg_f32:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    v_mul_f32_e32 v1, 0xbfb8aa3b, v0
; SI-NEXT:    s_mov_b32 s4, 0xbfb8aa3b
; SI-NEXT:    v_rndne_f32_e32 v2, v1
; SI-NEXT:    v_sub_f32_e32 v3, v1, v2
; SI-NEXT:    v_fma_f32 v1, v0, s4, -v1
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_nnan_daz:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_nnan_dynamic:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_ninf_daz:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_ninf_dynamic:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_nnan_ninf:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_nnan_ninf_daz:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_nnan_ninf_dynamic:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_dynamic_mode:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_fneg_fabs_v2f16:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_cvt_f32_f16_e64 v1, -|v0|
; GFX900-NEXT:    v_cvt_f32_f16_sdwa v0, -|v0| dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_v2f16_fast:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    s_movk_i32 s4, 0x3dc5
; GFX900-NEXT:    v_pk_mul_f16 v0, v0, s4 op_sel_hi:[1,0]
; GFX900-NEXT:    v_exp_f16_e32 v1, v0
; GFX900-NEXT:    v_exp_f16_sdwa v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX900-NEXT:    v_pack_b32_f16 v0, v1, v0
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_v3f16_afn:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    s_movk_i32 s4, 0x3dc5
; GFX900-NEXT:    v_mul_f16_e32 v2, 0x3dc5, v0
; GFX900-NEXT:    v_mul_f16_sdwa v0, v0, s4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX900-NEXT:    v_exp_f16_e32 v2, v2
; GFX900-NEXT:    v_exp_f16_e32 v0, v0
; GFX900-NEXT:    v_mul_f16_e32 v1, 0x3dc5, v1
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_contract:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_contract_daz:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SI-LABEL: v_exp_f32_contract_daz:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; SI-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_exp_f32_contract_nnan_ninf:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SI-LABEL: v_exp_f32_contract_nnan_ninf:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v0
; SI-NEXT:    s_mov_b32 s4, 0x3fb8aa3b
