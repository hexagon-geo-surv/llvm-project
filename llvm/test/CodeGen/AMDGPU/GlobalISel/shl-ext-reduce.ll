...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=hawaii < %s | FileCheck -check-prefixes=GCN,GFX7 %s
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-LABEL: v_shl_i32_zext_i16:
; GFX11-TRUE16:       ; %bb.0:
...
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3fff, v0
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v0, 2, v0
...
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_lshr_b32 s1, s0, 14
; GFX7-NEXT:    s_lshl_b32 s0, s0, 2
; GFX7-NEXT:    s_and_b32 s1, s1, 0xfffc
; GFX7-NEXT:    s_and_b32 s0, s0, 0xfffc
; GFX7-NEXT:    ; return to shader part epilog
;
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s1, s0, 0x3fff3fff
; GFX9-NEXT:    s_and_b32 s0, s1, 0x3fff
; GFX9-NEXT:    s_lshl_b32 s0, s0, 2
...
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 2, v0
; GFX7-NEXT:    v_and_b32_e32 v2, 0xfffc, v1
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, 14, v0
; GFX7-NEXT:    v_and_b32_e32 v1, 0xfffc, v0
...
; GFX8-NEXT:    v_and_b32_e32 v2, 0x3fff, v0
...
; GFX9-NEXT:    v_and_b32_e32 v2, 0x3fff, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v1, 14, v0
...
; GFX10-NEXT:    v_and_b32_e32 v0, 0x3fff, v1
; GFX10-NEXT:    v_lshrrev_b32_e32 v1, 14, v1
; GFX10-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v1, 0x3fff3fff, v0
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3fff, v1
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 14, v1
