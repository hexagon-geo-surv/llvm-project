...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -o - %s | FileCheck --check-prefix=GFX11 %s
...
; GFX11-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, s3
...
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_mul_hi_u32 s4, s0, s1
; GFX90A-NEXT:    s_mul_i32 s0, s0, s1
; GFX90A-NEXT:    s_add_u32 s0, s0, s2
; GFX90A-NEXT:    s_addc_u32 s1, s4, s3
...
; GFX7-NEXT:    s_mov_b64 s[0:1], 0
; GFX7-NEXT:    buffer_store_dwordx2 v[6:7], v[4:5], s[0:3], 0 addr64
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_add3_u32 v7, v7, v3, v1
