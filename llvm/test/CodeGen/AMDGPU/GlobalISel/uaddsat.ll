...
; GFX9-NEXT:    v_add_u16_sdwa v2, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:BYTE_0
...
; GFX10-NEXT:    v_min_u16 v1, 0xff, v2
...
; GFX11-FAKE16-NEXT:    v_min_u16 v1, 0xff, v2
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s2, 0xffff, s1
; GFX9-NEXT:    s_and_b32 s3, 0xffff, s0
...
; GFX9-NEXT:    s_add_i32 s0, s0, s1
; GFX9-NEXT:    s_and_b32 s1, s3, 0x1ff
; GFX9-NEXT:    s_and_b32 s0, s0, 0x1ff
; GFX9-NEXT:    s_min_u32 s1, s1, 0xff
; GFX9-NEXT:    s_min_u32 s0, s0, 0xff
...
; GFX9-NEXT:    v_add_u16_sdwa v4, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:BYTE_0
; GFX9-NEXT:    v_add_u16_sdwa v5, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
; GFX9-NEXT:    v_add_u16_sdwa v0, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_3 src1_sel:BYTE_3
; GFX9-NEXT:    v_add_u16_e32 v1, v3, v2
; GFX9-NEXT:    v_min_u16_e32 v4, 0xff, v4
; GFX9-NEXT:    v_min_u16_sdwa v5, v5, s4 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_min_u16_sdwa v0, v0, s4 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_min_u16_e32 v1, 0xff, v1
; GFX9-NEXT:    v_or_b32_e32 v4, v4, v5
; GFX9-NEXT:    v_or_b32_sdwa v0, v1, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX10-NEXT:    v_and_b32_sdwa v3, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX10-NEXT:    v_and_b32_e32 v1, 0xff, v1
...
; GFX10-NEXT:    v_add_nc_u16 v2, v6, v5
; GFX10-NEXT:    v_add_nc_u16 v4, v7, v4
; GFX10-NEXT:    v_add_nc_u16 v1, v8, v1
; GFX10-NEXT:    v_add_nc_u16 v0, v0, v3
; GFX10-NEXT:    v_min_u16 v2, 0xff, v2
; GFX10-NEXT:    v_min_u16 v3, 0xff, v4
; GFX10-NEXT:    v_min_u16 v1, 0xff, v1
; GFX10-NEXT:    v_min_u16 v0, 0xff, v0
...
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v4, 24, v1
; GFX11-FAKE16-NEXT:    v_lshrrev_b16 v5, 8, v1
; GFX11-FAKE16-NEXT:    v_lshrrev_b16 v6, 8, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v7, 24, v0
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v1, 0xff, v1
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v2, 0xff, v2
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v5, v6, v5
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v4, v7, v4
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v3, 0xff, v3
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v0, v0, v1
; GFX11-FAKE16-NEXT:    v_min_u16 v1, 0xff, v5
...
; GFX6-NEXT:    s_add_i32 s3, s3, s2
; GFX6-NEXT:    s_add_i32 s0, s0, s1
; GFX6-NEXT:    s_min_u32 s1, s3, 0xffff
; GFX6-NEXT:    s_min_u32 s0, s0, 0xffff
; GFX6-NEXT:    s_lshl_b32 s1, s1, 16
...
; GFX6-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v0, v3
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, v11, v10
; GFX6-NEXT:    v_min_u32_e32 v3, 0xffff, v3
...
; GFX6-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, v15, v14
; GFX6-NEXT:    v_min_u32_e32 v4, 0xffff, v4
