...
; RUN: llc -global-isel=1 -global-isel-abort=2 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-amd-amdhsa -mcpu=hawaii < %s | FileCheck -check-prefixes=GFX678,GFX678-GISEL,GFX6-GISEL %s
...
; GFX1251-SDAG-TRUE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
...
; GFX1251-GISEL-TRUE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
...
; GFX1251-SDAG-FAKE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
...
; GFX1251-GISEL-FAKE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
...
; GFX1251-TRUE16:       ; %bb.0:
; GFX1251-TRUE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
...
; GFX1251-FAKE16:       ; %bb.0:
; GFX1251-FAKE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
...
define <2 x double> @v_test_canonicalize_v2f64_uniform(<2 x double> inreg %arg) #1 {
; GFX678-LABEL: v_test_canonicalize_v2f64_uniform:
; GFX678:       ; %bb.0:
; GFX678-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX678-NEXT:    v_max_f64 v[0:1], s[16:17], s[16:17]
; GFX678-NEXT:    v_max_f64 v[2:3], s[18:19], s[18:19]
; GFX678-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: v_test_canonicalize_v2f64_uniform:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_max_f64 v[0:1], s[16:17], s[16:17]
; GFX9-NEXT:    v_max_f64 v[2:3], s[18:19], s[18:19]
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_test_canonicalize_v2f64_uniform:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_max_f64 v[0:1], s[0:1], s[0:1]
; GFX11-NEXT:    v_max_f64 v[2:3], s[2:3], s[2:3]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-LABEL: v_test_canonicalize_v2f64_uniform:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    s_wait_expcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_max_num_f64_e64 v[0:1], s[0:1], s[0:1]
; GFX12-NEXT:    v_max_num_f64_e64 v[2:3], s[2:3], s[2:3]
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1251-SDAG-TRUE16-LABEL: v_test_canonicalize_v2f64_uniform:
; GFX1251-SDAG-TRUE16:       ; %bb.0:
; GFX1251-SDAG-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1251-SDAG-TRUE16-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1251-SDAG-TRUE16-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX1251-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1251-SDAG-TRUE16-NEXT:    v_pk_max_num_f64 v[0:3], v[0:3], v[0:3]
; GFX1251-SDAG-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1251-GISEL-TRUE16-LABEL: v_test_canonicalize_v2f64_uniform:
; GFX1251-GISEL-TRUE16:       ; %bb.0:
; GFX1251-GISEL-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1251-GISEL-TRUE16-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1251-GISEL-TRUE16-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
...
; GFX1251-GISEL-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1251-SDAG-FAKE16-LABEL: v_test_canonicalize_v2f64_uniform:
; GFX1251-SDAG-FAKE16:       ; %bb.0:
; GFX1251-SDAG-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1251-SDAG-FAKE16-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1251-SDAG-FAKE16-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX1251-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1251-SDAG-FAKE16-NEXT:    v_pk_max_num_f64 v[0:3], v[0:3], v[0:3]
; GFX1251-SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1251-GISEL-FAKE16-LABEL: v_test_canonicalize_v2f64_uniform:
; GFX1251-GISEL-FAKE16:       ; %bb.0:
; GFX1251-GISEL-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1251-GISEL-FAKE16-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1251-GISEL-FAKE16-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
