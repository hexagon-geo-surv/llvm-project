...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GCN,GCN-GISEL,GCN-GISEL-FAKE16 %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GCN,GCN-GISEL,GCN-GISEL-REAL16 %s
...
; GCN-GISEL-FAKE16-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GCN-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-GISEL-FAKE16-NEXT:    v_or_b32_e32 v0, v1, v0
...
; GCN-GISEL-REAL16-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GCN-GISEL-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-GISEL-REAL16-NEXT:    v_or_b32_e32 v0, v1, v0
; GCN-GISEL-REAL16-NEXT:    global_store_b32 v[8:9], v0, off
