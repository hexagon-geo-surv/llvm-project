...
; xUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1013 < %s | FileCheck -check-prefixes=PRE-GFX12,GFX10,GFX10-GISEL,GFX1013-GISEL %s
...
;
; GFX10-GISEL-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX10-GISEL:       ; %bb.0: ; %main_body
; GFX10-GISEL-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x24
; GFX10-GISEL-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v5, 0x40400000
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v6, 4.0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v7, 0x40a00000
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v8, 0x40c00000
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v9, 0x40e00000
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v10, 0x41000000
...
; GFX10-GISEL-NEXT:    v_add_co_u32 v2, vcc_lo, v2, v4
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v3, vcc_lo
; GFX10-GISEL-NEXT:    flat_load_dword v0, v[0:1]
; GFX10-GISEL-NEXT:    flat_load_dword v1, v[2:3]
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v3, 1.0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v4, 2.0
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-GISEL-NEXT:    image_bvh_intersect_ray v[0:3], v[0:10], s[4:7]
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
...
; GFX1030-SDAG-NEXT:    s_endpgm
;
; GFX10-GISEL-LABEL: image_bvh_intersect_ray_a16_nsa_reassign:
; GFX10-GISEL:       ; %bb.0: ; %main_body
; GFX10-GISEL-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x24
; GFX10-GISEL-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v7, 0x48004700
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v6, 0x46004500
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v5, 0x44004200
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v4, 2.0
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    v_add_co_u32 v0, s0, s0, v2
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v1, null, s1, 0, s0
; GFX10-GISEL-NEXT:    v_add_co_u32 v2, s0, s2, v2
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v3, null, s3, 0, s0
; GFX10-GISEL-NEXT:    flat_load_dword v0, v[0:1]
; GFX10-GISEL-NEXT:    flat_load_dword v1, v[2:3]
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v3, 1.0
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-GISEL-NEXT:    image_bvh_intersect_ray v[0:3], v[0:7], s[4:7] a16
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX10-GISEL-NEXT:    s_endpgm
;
...
; GFX1030-SDAG-NEXT:    s_endpgm
;
; GFX10-GISEL-LABEL: image_bvh64_intersect_ray_nsa_reassign:
; GFX10-GISEL:       ; %bb.0: ; %main_body
; GFX10-GISEL-NEXT:    s_clause 0x1
; GFX10-GISEL-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX10-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; GFX10-GISEL-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v3, 0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v4, 1.0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v5, 2.0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v6, 0x40400000
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v7, 4.0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v8, 0x40a00000
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v9, 0x40c00000
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v10, 0x40e00000
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v11, 0x41000000
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v0, s6
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v1, s7
; GFX10-GISEL-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v2
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
; GFX10-GISEL-NEXT:    flat_load_dword v2, v[0:1]
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v0, 0xb36211c7
; GFX10-GISEL-NEXT:    v_bfrev_b32_e32 v1, 4.0
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-GISEL-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:11], s[0:3]
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX10-GISEL-NEXT:    s_endpgm
;
...
; GFX1030-SDAG-NEXT:    s_endpgm
;
; GFX10-GISEL-LABEL: image_bvh64_intersect_ray_a16_nsa_reassign:
; GFX10-GISEL:       ; %bb.0: ; %main_body
; GFX10-GISEL-NEXT:    s_clause 0x1
; GFX10-GISEL-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX10-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
...
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v3, 0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v8, 0x48004700
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v7, 0x46004500
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v6, 0x44004200
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v5, 2.0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v4, 1.0
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    v_add_co_u32 v0, s4, s6, v0
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v1, null, s7, 0, s4
; GFX10-GISEL-NEXT:    flat_load_dword v2, v[0:1]
; GFX10-GISEL-NEXT:    v_bfrev_b32_e32 v1, 4.0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v0, 0xb36211c6
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-GISEL-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:8], s[0:3] a16
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX10-GISEL-NEXT:    s_endpgm
;
