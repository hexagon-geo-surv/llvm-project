...
; RUN: llc -global-isel=1 -global-isel-abort=2 -O2 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=GISEL12 %s
; RUN: llc -global-isel=0 -O2 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=DAGISEL12 %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -O2 -mtriple=amdgcn -mcpu=gfx1030 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=GISEL10 %s
...
; GISEL12-NEXT:    s_mov_b32 s7, s6
; GISEL12-NEXT:    s_mov_b32 s6, s5
; GISEL12-NEXT:    s_mov_b32 s5, s4
; GISEL12-NEXT:    s_mov_b32 s4, s3
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_and_saveexec_b64 s[8:9], s[10:11]
...
; GISEL12-NEXT:    s_or_b64 exec, exec, s[8:9]
...
; GISEL10-NEXT:    s_mov_b32 s7, s6
; GISEL10-NEXT:    s_mov_b32 s6, s5
; GISEL10-NEXT:    s_mov_b32 s5, s4
; GISEL10-NEXT:    s_mov_b32 s4, s3
; GISEL10-NEXT:    s_and_saveexec_b64 s[8:9], s[10:11]
...
; GISEL10-NEXT:    s_or_b64 exec, exec, s[8:9]
