...
; CHECK-NEXT:    call void @func() #[[ATTR13:[0-9]+]]
; CHECK-NEXT:    call void @func() #[[ATTR14:[0-9]+]]
; CHECK-NEXT:    call void @func() #[[ATTR15:[0-9]+]]
; CHECK-NEXT:    ret void
;
...
; CHECK: attributes #[[ATTR6]] = { denormal_fpenv(float: preservesign,preservesign) }
; CHECK: attributes #[[ATTR7]] = { denormal_fpenv(float: dynamic,dynamic) }
; CHECK: attributes #[[ATTR8]] = { denormal_fpenv(float: positivezero,positivezero) }
...
; CHECK: attributes #[[ATTR11]] = { denormal_fpenv(dynamic,dynamic float: preservesign,preservesign) }
; CHECK: attributes #[[ATTR12]] = { denormal_fpenv(dynamic,positivezero float: dynamic,preservesign) }
; CHECK: attributes #[[ATTR13]] = { "denormal-fp-math"="preserve-sign,preserve-sign" }
; CHECK: attributes #[[ATTR14]] = { "denormal-fp-math-f32"="preserve-sign,preserve-sign" }
; CHECK: attributes #[[ATTR15]] = { "denormal-fp-math"="dynamic,ieee" "denormal-fp-math-f32"="preserve-sign,preserve-sign" }
;.
