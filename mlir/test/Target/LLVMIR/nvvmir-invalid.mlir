...
llvm.func @nvvm_fence_proxy_acquire(%addr : !llvm.ptr, %size : i32) {
  ...
  nvvm.fence.proxy.acquire cta %addr, %size from_proxy=#nvvm.proxy_kind<tensormap> to_proxy=#nvvm.proxy_kind<generic>
  llvm.return
}
...
llvm.func @nvvm_fence_proxy_release() {
  ...
  nvvm.fence.proxy.release cta from_proxy=#nvvm.proxy_kind<tensormap> to_proxy=#nvvm.proxy_kind<generic>
  llvm.return
}
...
llvm.func @nvvm_fence_proxy_acquire(%addr : !llvm.ptr, %size : i32) {
  ...
  nvvm.fence.proxy.acquire cta %addr, %size  from_proxy=#nvvm.proxy_kind<generic> to_proxy=#nvvm.proxy_kind<generic>
  llvm.return
}
...
llvm.func @nvvm_fence_proxy_release() {
  ...
  nvvm.fence.proxy.release cta from_proxy=#nvvm.proxy_kind<generic> to_proxy=#nvvm.proxy_kind<generic>
  llvm.return
}
