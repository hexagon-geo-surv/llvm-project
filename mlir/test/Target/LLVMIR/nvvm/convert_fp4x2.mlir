...
llvm.func @convert_f4x2_to_bf16x2(%src : i8, %scale_factor : i16) {
  ...
  %res3 = nvvm.convert.f4x2.to.bf16x2 %src  sat = <satfinite> : i8 (f4E2M1FN) -> vector<2xbf16>
  ...
  %res4 = nvvm.convert.f4x2.to.bf16x2 %src  sat = <satfinite> relu = true : i8 (f4E2M1FN) -> vector<2xbf16>
