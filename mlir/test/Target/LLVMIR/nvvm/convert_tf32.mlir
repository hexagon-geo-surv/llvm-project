...
llvm.func @convert_float_to_tf32_rna(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rna>
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rna_sf(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rna> sat = <satfinite>
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rn(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rn>
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rn_relu(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rn> relu = true
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rn_sf(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rn> sat = <satfinite>
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rn_relu_sf(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rn> sat = <satfinite> relu = true
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rz(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rz>
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rz_relu(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rz> relu = true
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rz_sf(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rz> sat = <satfinite>
  llvm.return %res : i32
}
...
llvm.func @convert_float_to_tf32_rz_relu_sf(%src : f32) -> i32 {
  ...
  %res = nvvm.convert.float.to.tf32 %src  rnd = <rz> sat = <satfinite> relu = true
  llvm.return %res : i32
}
