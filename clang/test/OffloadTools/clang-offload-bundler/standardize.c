...
// RUN: %clang -O0 -target x86_64-unknown-linux-gnu %s -c -o %t.o
...
// BUNDLE: Compatible: Exact match: [CodeObject: hip-amdgpu-amd-amdhsa--gfx906] : [Target: hip-amdgcn-amd-amdhsa--gfx906]
// BUNDLE: Compatible: Exact match: [CodeObject: hip-amdgpu-amd-amdhsa--gfx908] : [Target: hip-amdgcn-amd-amdhsa--gfx908]
